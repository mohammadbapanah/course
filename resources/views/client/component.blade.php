					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title">المان ها</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0">
										<li class="breadcrumb-item"><a href="#">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">المان ها</li>
									</ol>
								</nav>
							</div>
			...
			<section>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							...
							<div class="custom-tab customize-tab tabs_creative">
								<ul class="nav nav-tabs pb-2 b-0" id="myTab" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">حساب کاربری</a>
									</li>
									<li class="nav-item">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<h4>نمونه آکاردئون (Accordion)</h4>
							<div id="accordionExample" class="accordion">

								<!-- Part 1 -->
								<div class="card">
								  <div id="headingOne" class="card-header bg-white shadow-sm border-0">
									<h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="d-block position-relative text-dark collapsible-link py-2">نحوه یادگیری طراحی وب سایت به صورت گام به گام</a></h6>
								  </div>
								...
								<div class="card">
								  <div id="headingTwo" class="card-header bg-white shadow-sm border-0">
									<h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="d-block position-relative collapsed text-dark collapsible-link py-2">آموزش طراحی وب در سطح پایه</a></h6>
								  </div>
								...
								<div class="card">
								  <div id="headingThree" class="card-header bg-white shadow-sm border-0">
									<h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="d-block position-relative collapsed text-dark collapsible-link py-2">آموزش طراحی وب در سطح پیشرفته</a></h6>
								  </div>
								...
								<div class="card">
								  <div id="headingFour" class="card-header bg-white shadow-sm border-0">
									<h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" class="d-block position-relative collapsed text-dark collapsible-link py-2">چگونه در طراحی و توسعه موفق شویم؟</a></h6>
								  </div>
					...
					<div class="row mt-4">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<h4>نمونه دکمه (Button)</h4>
							<button type="submit" class="btn theme-bg">پیش فرض 1</button></br>
							<button type="submit" class="btn theme-bg btn-rounded">پیش فرض 2</button>
							<button type="submit" class="btn theme-bg btn-md">استاندارد</button></br>
							<button type="submit" class="btn bg-dark btn-lg">بزرگ</button>
							<button type="submit" class="btn btn-outline-theme">بی رنگ</button></br></br>
							<a href="#" class="btn btn-theme">پیش فرض 3</a></br>
							<a href="#" class="btn btn-theme-2">پیش فرض 4</a>
						</div>
					...
					<div class="row mt-4">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<h4>چک باکس و رادیو باتن</h4>
							<ul class="no-ul-list">
								<li>
									<input id="a-1" class="checkbox-custom" name="a-1" type="checkbox">
									<label for="a-1" class="checkbox-custom-label">دوره رایگان</label>
								</li>
								<li>
									<input id="a-2" class="checkbox-custom" name="a-2" type="checkbox">
									<label for="a-2" class="checkbox-custom-label">دوره پولی</label>
								</li>
							...
							<ul class="no-ul-list">
								<li>
									...
									<label for="a-p" class="checkbox-custom-label">دوره حضوری</label>
								</li>
								<li>
									<input id="a-c" class="checkbox-custom" name="a-c" type="radio">
									<label for="a-c" class="checkbox-custom-label">دوره آنلاین</label>
								</li>
