										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">درباره اپلیکیشن</li>
												</ol>
											</nav>
										</div>
									</div>
										...
										<div class="row justify-content-center">
											<div class="col-xl-8 col-lg-10 col-md-12">
												...
												<div class="abt_apps">
													<ul>
														<li>
															<div class="abt_left">نسخه اپلیکیشن</div>
															<div class="abt_right"><span>6.04</span></div>
														</li>
														<li>
															<div class="abt_left">آخرین بروزرسانی</div>
															<div class="abt_right"><span>10 اردیبهشت 1400</span></div>
														</li>
														<li>
															<div class="abt_left">6 ماه پشتیبانی بیشتر </div>
															<div class="abt_right"><span class="elso bg-light-success text-success">فعال</span></div>
														</li>
														<li>
															<div class="abt_left">نسخه PHP</div>
															<div class="abt_right"><span>7.4.27</span></div>
														</li>
														<li>
															<div class="abt_left">کد خرید</div>
															<div class="abt_right"><span>fgthyu678u52iol</span></div>
														</li>
														<li>
															<div class="abt_left">مهلت پشتیبانی</div>
															<div class="abt_right"><span class="elso bg-light-danger text-danger">منقضی</span></div>
														</li>
													</ul>
												</div>
