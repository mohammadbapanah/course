					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title font-2">موردعلاقه ها</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0 bg-white">
										<li class="breadcrumb-item"><a href="#">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">موردعلاقه ها</li>
									</ol>
								</nav>
							</div>
								...
								<table class="table table-striped wishlist">
									<tbody>
										<tr>
											...
											<td><div class="tb_course_thumb"><img src="assets/img/cr-1.jpg" class="img-fluid" alt="" /></div></td>
											<th>کتاب فارسی جامع کنکور جلد یک<span class="tb_date">18 آبان 1400</span></th>
											<td><span class="wish_price theme-cl">۴۲,۷۵۰ تومان</span></td>
											<td>موجود در انبار</td>
											<td><a href="#" class="btn theme-bg text-white">افزودن</span></td>
										</tr>
										<tr>
											<td><a href="#" class="remove_cart"><i class="ti-close"></i></a></td>
											<td><div class="tb_course_thumb"><img src="assets/img/cr-2.jpg" class="img-fluid" alt="" /></div></td>
											<th>کتاب فارسی جامع کنکور جلد یک<span class="tb_date">10 مهر 1400</span></th>
											<td><span class="wish_price theme-cl">۴۲,۷۵۰ تومان</span></td>
											<td>موجود در انبار</td>
											<td><a href="#" class="btn theme-bg text-white">افزودن</span></td>
										</tr>
										<tr>
											<td><a href="#" class="remove_cart"><i class="ti-close"></i></a></td>
											<td><div class="tb_course_thumb"><img src="assets/img/cr-3.jpg" class="img-fluid" alt="" /></div></td>
											<th>کتاب فارسی جامع کنکور جلد یک<span class="tb_date">13 شهریور 1400</span></th>
											<td><span class="wish_price theme-cl">۴۲,۷۵۰ تومان</span></td>
											<td>موجود در انبار</td>
											<td><a href="#" class="btn theme-bg text-white">افزودن</span></td>
										</tr>
										<tr>
											<td><a href="#" class="remove_cart"><i class="ti-close"></i></a></td>
											<td><div class="tb_course_thumb"><img src="assets/img/cr-4.jpg" class="img-fluid" alt="" /></div></td>
											<th>کتاب فارسی جامع کنکور جلد یک<span class="tb_date">12 مرداد 1400</span></th>
											<td><span class="wish_price theme-cl">۴۲,۷۵۰ تومان</span></td>
											<td>موجود در انبار</td>
											<td><a href="#" class="btn theme-bg text-white">افزودن</span></td>
										</tr>
										<tr>
											<td><a href="#" class="remove_cart"><i class="ti-close"></i></a></td>
											<td><div class="tb_course_thumb"><img src="assets/img/cr-5.jpg" class="img-fluid" alt="" /></div></td>
											<th>کتاب فارسی جامع کنکور جلد یک<span class="tb_date">11 اردیبهشت 1400</span></th>
											<td><span class="wish_price theme-cl">۴۲,۷۵۰ تومان</span></td>
											<td>موجود در انبار</td>
											<td><a href="#" class="btn theme-bg text-white">افزودن</span></td>
										</tr>
