					...
					<div class="row submit-page mb-4">
						<div class="xl-12 col-lg-12 col-md-12">
							<div class="alert alert-success text-center mb-0" role="alert">
								سلام، آیا شما در سایت ثبت نام کرده اید؟ <a href="#" data-toggle="collapse" data-target="#login-frm">ورود به حساب</a>
							</div>
						</div>
							...
							<div id="login-frm" class="collapse mt-3">
								<div class="row">
									...
									<div class="col-lg-2 col-md-4 col-sm-12">
										<div class="form-group">
											<button type="submit" class="btn theme-bg text-white btn-md full-width">ورود به حساب</button>
										</div>
									</div>

									<div class="col-lg-3 col-md-4 col-sm-6">
										<input id="a-1" class="checkbox-custom" name="a-1" type="checkbox">
										<label for="a-1" class="checkbox-custom-label">مرا به خاطر بسپار</label>
									</div>

									<div class="col-lg-3 col-md-4 col-sm-6 mt-2">
										<a href="#" class="theme-cl">رمز خود را فراموش کرده اید؟</a>
									</div>
							...
							<div class="submit-page mb-4">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>نام و نام خانوادگی<i class="req">*</i></label>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>پست الکترونیکی<i class="req">*</i></label>
											<input type="text" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											<label>کشور<i class="req">*</i></label>
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div class="form-group">
											<label>خیابان<i class="req">*</i></label>
											<input type="text" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>شهرستان<i class="req">*</i></label>
											<select id="town" class="form-control">
												<option value="">&nbsp;</option>
												<option value="1">شیراز</option>
												<option value="2">آمستردام</option>
												<option value="3">آنتالیا</option>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>استان<i class="req">*</i></label>
											<input type="text" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>کدپستی<i class="req">*</i></label>
											<input type="text" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											<label>شماره همراه<i class="req">*</i></label>
											<input type="text" class="form-control">
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="form-group">
											...
											<label for="a-2" class="checkbox-custom-label">ایجاد اکانت</label>
										</div>
									</div>
							...
							<div class="panel-group pay_opy980" id="payaccordion">
								...
								<div class="panel panel-default border">
									<div class="panel-heading" id="pay">
										<h4 class="panel-title">
											<a data-toggle="collapse" role="button" data-parent="#payaccordion" href="#payPal" aria-expanded="true"  aria-controls="payPal" class="">پرداخت آنلاین<img src="assets/img/paypal.html" class="img-fluid" alt=""></a>
										</h4>
									</div>
									<div id="payPal" class="panel-collapse collapse show" aria-labelledby="pay" data-parent="#payaccordion">
										<div class="panel-body">
											<form>
												<div class="form-group">
													<label>ایمیل PayPal</label>
													<input type="text" class="form-control simple" placeholder="paypal@gmail.com">
												</div>
												<div class="form-group">
													<button type="submit" class="btn theme-bg btm-md full-width">پرداخت 400.000 تومان</button>
												</div>
											</form>
										</div>
									</div>
								...
								<div class="panel panel-default border">
									<div class="panel-heading" id="stripes">
										<h4 class="panel-title">
											<a data-toggle="collapse" role="button" data-parent="#payaccordion" href="#stripePay" aria-expanded="false"  aria-controls="stripePay" class="">کارت به کارت<img src="assets/img/strip.html" class="img-fluid" alt=""></a>
										</h4>
									</div>
												...
												<div class="row">
													...
													<div class="col-lg-6 col-md-6 col-sm-12">
														<div class="form-group">
															...
															<label for="ak-2" class="checkbox-custom-label">با ادامه فرآیند، شرایط سایت را قبول خواهم کرد.</label>
														</div>
													</div>

													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="form-group text-center">
															<a href="#" class="btn theme-bg full-width">پرداخت 202.000 تومان</a>
														</div>
													</div>
								...
								<div class="panel panel-default border">
									<div class="panel-heading" id="dabit">
										<h4 class="panel-title">
											<a data-toggle="collapse" href="#payaccordion" data-target="#debitPay" aria-expanded="false"  aria-controls="debitPay" class="">کیف پول<img src="assets/img/debit.html" class="img-fluid" alt=""></a>
										</h4>
									</div>
