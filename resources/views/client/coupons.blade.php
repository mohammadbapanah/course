									...
									<ul id="side-menu">
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-course.blade.php">لیست دوره ها</a></li>
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-admins.blade.php">لیست مدیرها</a></li>
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-instructor.blade.php">لیست مدرس</a></li>
												<li><a href="../admin/add-instructor.blade.php">ثبت مدرس جدید</a></li>
												<li><a href="../admin/instructor-payout.blade.php">لیست پرداخت ها</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-user"></i>هنرجویان<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-students.blade.php">لیست هنرجویان</a></li>
												<li><a href="../admin/add-students.blade.php">ثبت هنرجو جدید</a></li>
											</ul>
										</li>
										<li><a href="../admin/addon-manager.blade.php"><i class="fas fa-layer-group"></i>افزونه های من</a></li>
										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">تخفبفات</li>
												</ol>
											</nav>
										</div>
										<div class="elkios">
											<a href="#" class="add_new_btn" data-toggle="modal" data-target="#couponModal"><i class="fas fa-plus-circle ml-1"></i>افزودن کد تخفیف</a>
										</div>
									</div>
								</div>
							</div>
