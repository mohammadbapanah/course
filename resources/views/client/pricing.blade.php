					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title text-light font-2">قیمت گذاری</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0">
										<li class="breadcrumb-item"><a href="#" class="text-light">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">قیمت گذاری</li>
									</ol>
								</nav>
							</div>
			...
			<section class="gray">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8">
							<div class="sec-heading center">
								<h3 class="font-2">اخذ نمایندگان <span class="theme-cl">آموزش</span></h3>
								<p>با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
							</div>
						</div>
					</div>
