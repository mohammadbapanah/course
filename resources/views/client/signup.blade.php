								...
								<div class="crs_log_wrap">
									...
									<div class="crs_log__caption">
										...
										<div class="rcs_log_124">
											...
											<div class="form-group">
												<button type="button" class="btn full-width btn-md theme-bg text-white">ثبت نام</button>
											</div>
										</div>
									...
									<div class="crs_log__footer d-flex justify-content-between">
										<div class="fhg_45"><p class="musrt">آیا حساب  کاربری دارید؟ <a href="login.blade.php" class="theme-cl">ورود</a></p></div>
										<div class="fhg_45"><p class="musrt"><a href="forgot.blade.php" class="text-danger">آیا رمز عبور خود را فراموش کرده اید؟</a></p></div>
									</div>
								</div>
							</form>
						</div>
