									...
									<li>
										<div class="btn-group account-drop">
											...
											<div class="dropdown-menu pull-right animated flipInX">
												...
												<ul>
													<li><a href="dashboard.blade.php"><i class="fa fa-tachometer-alt"></i>پیشخوان<span class="notti_coun style-1">4</span></a></li>
													<li><a href="my-profile.blade.php"><i class="fa fa-user-tie"></i>پروفایل کاربری</a></li>
													<li><a href="../admin/manage-course.blade.php"><i class="fas fa-shopping-basket"></i>دوره های من<span class="notti_coun style-2">7</span></a></li>
													<li><a href="../admin/manage-instructor.blade.php"><i class="fas fa-toolbox"></i>مدرسین من</a></li>
													<li><a href="../admin/manage-students.blade.php"><i class="fa fa-envelope"></i>هنرجویان من<span class="notti_coun style-3">3</span></a></li>
													<li><a href="../admin/messages.blade.php"><i class="fas fa-comments"></i>پیام ها</a></li>
													<li><a href="login.blade.php"><i class="fa fa-unlock-alt"></i>خروج</a></li>
												</ul>
											</div>
										</div>
									</li>
						...
						<div class="col-lg-3 col-md-3">
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul id="side-menu">
										<li class="active"><a href="dashboard.blade.php"><i class="fas fa-th"></i>پیشخوان</a></li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-shopping-basket"></i>دوره های آموزش<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-course.blade.php">مدیریت</a></li>
												<li><a href="../admin/add-new-course.blade.php">افزودن دوره جدید</a></li>
												<li><a href="../admin/course-category.blade.php">دسته بندی دوره</a></li>
												<li><a href="coupons.blade.php">تخفیفات</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-gem"></i>ثبت نام ها<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/enroll-history.blade.php">تاریخچه</a></li>
												<li><a href="../admin/enroll-student.blade.php">ثبت نام هنرجو</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-archive"></i>گزارشات<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/admin-revenue.blade.php">درآمد ادمین</a></li>
												<li><a href="../admin/instructor-revenue.blade.php">درآمد مربی</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-user-shield"></i>مدیرها<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-admins.blade.php">مدیریت</a></li>
												<li><a href="../admin/add-admin.blade.php">افزودن مدیر جدید</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-toolbox"></i>مدرسین<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-instructor.blade.php">مدیریت</a></li>
												<li><a href="../admin/add-instructor.blade.php">ثبت مدرس جدید</a></li>
												<li><a href="../admin/instructor-payout.blade.php">پرداخت های مدرس</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-user"></i>هنرجویان<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/manage-students.blade.php">مدیریت</a></li>
												<li><a href="../admin/add-students.blade.php">ثبت هنرجو جدید</a></li>
											</ul>
										</li>
										<li><a href="../admin/addon-manager.blade.php"><i class="fas fa-layer-group"></i>افزونه ها</a></li>
										<li><a href="themes.html"><i class="fas fa-paint-brush"></i>قالب ها</a></li>
										<li><a href="../admin/messages.blade.php"><i class="fas fa-comments"></i>پیام ها</a></li>
										<li><a href="my-profile.blade.php"><i class="fas fa-address-card"></i>پروفایل کاربری</a></li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-cog"></i>تنظیمات<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="../admin/website-settings.blade.php">وب سایت</a></li>
												<li><a href="../admin/system-settings.blade.php">سئو</a></li>
												<li><a href="payment_settings.html">پرداخت</a></li>
												<li><a href="social-login.blade.php">شبکه های اجتماعی</a></li>
												<li><a href="smtp-setting.html">ایمیل SMTP</a></li>
												<li><a href="dash-about.blade.php">درباره اپلیکیشن</a></li>
											</ul>
										</li>
									</ul>
								</div>
										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">شبکه اجتماعی</li>
												</ol>
											</nav>
										</div>
									</div>
										...
										<div class="row justify-content-between">
											<div class="col-xl-6 col-lg-6 col-md-12">
												<div class="form-group smalls">
													<h6 class="m-0">اطلاعات Facebook</h6>
												</div>
												<div class="form-group smalls">
													<div class="d-flex">
														<div class="drios">
															<input id="456" class="checkbox-custom" name="flog" type="radio" checked>
															<label for="456" class="checkbox-custom-label">فعال</label>
														</div>
														<div class="drios ml-3">
															<input id="457" class="checkbox-custom" name="flog" type="radio">
															<label for="457" class="checkbox-custom-label">غیرفعال</label>
														</div>
													</div>
												</div>
												<div class="form-group smalls">
													<label>شناسه اپلیکیشن فیسبوک*</label>
													<input type="text" class="form-control" value="JGHJDGJH487258" />
												</div>

												<div class="form-group smalls">
													<label>رمز فیسبوک</label>
													<input type="text" class="form-control" value="JJKGKJGFEJKHFK524" />
												</div>

												<div class="form-group smalls">
													<button type="button" class="btn theme-bg text-white">ذخیره</button>
												</div>
											...
											<div class="col-xl-6 col-lg-6 col-md-12">
												<div class="form-group smalls">
													<h6 class="m-0">اطلاعات Twitter</h6>
												</div>

												<div class="form-group smalls">
													<div class="d-flex">
														<div class="drios">
															<input id="452" class="checkbox-custom" name="tlog" type="radio" checked>
															<label for="452" class="checkbox-custom-label">فعال</label>
														</div>
														<div class="drios ml-3">
															<input id="453" class="checkbox-custom" name="tlog" type="radio">
															<label for="453" class="checkbox-custom-label">غیرفعال</label>
														</div>
													</div>
												</div>

												<div class="form-group smalls">
													<label>شناسه اپلیکیشن توییتر*</label>
													<input type="text" class="form-control" value="JGHJDGJH487258" />
												</div>

												<div class="form-group smalls">
													<label>رمز توییتر*</label>
													<input type="text" class="form-control" value="JJKGKJGFEJKHFK524" />
												</div>
