					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title font-2">نمای لیست با سایدبار</h1>
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb p-0 bg-white">
										<li class="breadcrumb-item"><a href="#">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">نمای لیست با سایدبار</li>
									</ol>
								</nav>
							</div>
							...
							<div class="row justify-content-center">
									...
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											...
											<div class="crs_grid_list_caption">
												<div class="crs_lt_101">
													<span class="est st_1">آموزش</span>
													<span class="est st_2">ریاضیات</span>
												</div>
												<div class="crs_lt_102">
													<h4 class="crs_tit">آموزش ریاضی پایه - مرور و حل تست کنکور ارشد</h4>
													<span class="crs_auth"><i>مدرس</i> مژگان حسینی</span>
												</div>
												<div class="crs_lt_103">
													<div class="crs_info_detail">
														<ul>
															<li><i class="fa fa-video"></i><span>24 دوره آموزشی</span></li>
															<li><i class="fa fa-user"></i><span>10 شرکت کننده</span></li>
															<li><i class="fa fa-eye"></i><span>92 بازدید</span></li>
														</ul>
													</div>
												</div>
												<div class="crs_flex">
										...
										<div class="lt_cr_footer">
											<div class="lt_cr_footer_first">
												<ul class="lt_cr_list">
													<li><a href="#" class="prv_li"><i class="fa fa-play text-success"></i>مشاهده پیش نمایش</a></li>
												</ul>
											</div>
									...
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											...
											<div class="crs_grid_list_caption">
												<div class="crs_lt_101">
													<span class="est st_1">آموزش</span>
													<span class="est st_2">بازار سهام</span>
												</div>
												<div class="crs_lt_102">
													<h4 class="crs_tit">آموزش نوسان گیری در بورس - مقدماتی</h4>
													<span class="crs_auth"><i>مدرس</i> کیوان محمدی</span>
												</div>
												<div class="crs_lt_103">
													<div class="crs_info_detail">
														<ul>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											<div class="crs_grid_list_thumb">
												<a href="course-detail.html"><img src="assets/img/cr-6.jpg" class="img-fluid rounded" alt=""></a>
											</div>

											<div class="crs_grid_list_caption">
												<div class="crs_lt_101">
													<span class="est st_1">آموزش</span>
													<span class="est st_2">زبان</span>
												</div>
												<div class="crs_lt_102">
													<h4 class="crs_tit">آموزش اصول و روش تحقیق + نکات شرکت کننده ی زبان</h4>
													<span class="crs_auth"><i>مدرس</i> امین بهراملو</span>
												</div>
												<div class="crs_lt_103">
													<div class="crs_info_detail">
														<ul>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											<div class="crs_grid_list_thumb">
												<a href="course-detail.html"><img src="assets/img/cr-7.jpg" class="img-fluid rounded" alt=""></a>
											</div>

											<div class="crs_grid_list_caption">
												<div class="crs_lt_101">
													<span class="est st_1">آموزش</span>
													<span class="est st_2">گرافیک</span>
												</div>
												<div class="crs_lt_102">
													<h4 class="crs_tit">آموزش تدوین و میکس دوره آموزشی با Premier</h4>
													<span class="crs_auth"><i>مدرس</i> مسعود علیزاده</span>
												</div>
												<div class="crs_lt_103">
													<div class="crs_info_detail">
														<ul>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											<div class="crs_grid_list_thumb">
												<a href="course-detail.html"><img src="assets/img/cr-8.jpg" class="img-fluid rounded" alt=""></a>
											</div>

											<div class="crs_grid_list_caption">
												<div class="crs_lt_101">
													<span class="est st_1">آموزش</span>
													<span class="est st_2">برنامه نویسی</span>
												</div>
												<div class="crs_lt_102">
													<h4 class="crs_tit">آموزش ساخت فروشگاه دیجی استایل با لاراول</h4>
													<span class="crs_auth"><i>مدرس</i> حسین عظیمی</span>
												</div>
												<div class="crs_lt_103">
													<div class="crs_info_detail">
														<ul>
