...
<head>
    ...
    <body dir="rtl">
        ...
        <div id="main-wrapper">
			...
			<!-- ============================ Page Title Start================================== -->
			<section class="page-title bg-cover" style="background:url(assets/img/banner-3.jpg)no-repeat;" data-overlay="8">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">

							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title text-light font-2">لیست وبلاگ</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0">
										<li class="breadcrumb-item"><a href="#" class="text-light">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">لیست وبلاگ</li>
									</ol>
								</nav>
							</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-1.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>بازاریابی</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">چطور زبان انگلیسی را سریع یاد بگیریم؟</a></h4></div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-2.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>کسب و کار</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">کلید سوالات کنکور برای رشته های مختلف</a></h4></div>
									<div class="blg_desc"><p>لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد</p></div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-3.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>حسابداری</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">چطور امتحان حضوری موفقی داشته باشیم؟</a></h4></div>
									<div class="blg_desc"><p>لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد</p></div>
								</div>
								<div class="crs_grid_foot">
									<div class="crs_flex">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-4.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>بازاریابی</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">چطور زبان انگلیسی را سریع یاد بگیریم؟</a></h4></div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-5.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>کسب و کار</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">کلید سوالات کنکور برای رشته های مختلف</a></h4></div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="blg_grid_box">
								<div class="blg_grid_thumb">
									<a href="blog-detail.blade.php"><img src="assets/img/b-6.png" class="img-fluid" alt="" /></a>
								</div>
								<div class="blg_grid_caption">
									<div class="blg_tag"><span>حسابداری</span></div>
									<div class="blg_title"><h4><a href="blog-detail.blade.php">کلید سوالات کنکور برای رشته های مختلف</a></h4></div>
