					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title font-2">دسته بندی ها</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0">
										<li class="breadcrumb-item"><a href="#">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">دسته بندی ها</li>
									</ol>
								</nav>
							</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 text-center">
							<a href="javascript:void(0);" class="btn theme-cl theme-bg-light btn-md">سایر دسته بندی ها</a>
						</div>
					</div>
