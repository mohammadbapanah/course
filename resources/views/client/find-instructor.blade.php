						...
						<div class="nav-menus-wrapper">
							<ul class="nav-menu">
								...
								<li class="active"><a href="#">خانه<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu">
										...
										<li><a href="home-4.blade.php">خانه 4</a></li>
								...
								<li><a href="#">دوره های آموزشی<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu">
										...
										<li><a href="#">نمای لیستی<span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu">
												<li><a href="list-layout-with-sidebar.blade.php">با سایدبار</a></li>
										...
										<li><a href="#">جزئیات دوره<span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu">
												...
												<li><a href="course-detail-4.blade.php">نسخه 4</a></li>
											</ul>
										</li>

										<li><a href="explore-category.blade.php">انتخاب دسته بندی</a></li>
										<li><a href="find-instructor.blade.php">لیست مدرسین</a></li>
										<li><a href="instructor-detail.blade.php">جزئیات مدرس</a></li>
									</ul>
								</li>
									...
									<ul class="nav-dropdown nav-submenu">
										<li><a href="#">فروشگاه<span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu">
												...
												<li><a href="wishlist.blade.php">موردعلاقه ها</a></li>
												<li><a href="checkout.blade.php">تسویه حساب</a></li>
												<li><a href="product-detail.blade.php">جزئیات محصول</a></li>
											</ul>
										</li>
										<li><a href="about.blade.php">درباره ما</a></li>
										<li><a href="contact.blade.php">تماس با ما</a></li>
										<li><a href="blogs.blade.php">لیست وبلاگ</a></li>
										<li><a href="pricing.blade.php">قیمت گذاری</a></li>
										<li><a href="404.blade.php">صفحه 404</a></li>
										<li><a href="component.blade.php">المان ها</a></li>
										<li><a href="faq.blade.php">سوالات متداول</a></li>
										<li><a href="login.blade.php">ورود</a></li>
										<li><a href="signup.blade.php">ثبت نام</a></li>
										<li><a href="forgot.blade.php">فراوشی رمز عبور</a></li>
									</ul>
								</li>

								<li><a href="dashboard.blade.php">حساب کاربری</a></li>
							...
							<ul class="nav-menu nav-menu-social align-to-left">
								...
								<li class="add-listing theme-bg">
									<a href="signup.blade.php" class="text-white">ثبت نام</a>
								</li>
							</ul>
						</div>
					</nav>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title font-2">لیست مدرسین</h1>
								<nav class="transparent">
									<ol class="breadcrumb p-0 bg-white">
										<li class="breadcrumb-item"><a href="#">خانه</a></li>
										<li class="breadcrumb-item active theme-cl" aria-current="page">لیست مدرسین</li>
									</ol>
								</nav>
							</div>
										...
										<div class="form-group">
											<div class="simple-input">
												<select id="cates" class="form-control">
													<option value="">&nbsp;</option>
													<option value="1">فناوری و اطلاعات</option>
													<option value="2">حسابداری</option>
													<option value="3">شبکه اجتماعی</option>
													<option value="4">طراحی اپلیکیشن</option>
													<option value="5">حسابداری ومالی</option>
												</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<ul class="no-ul-list mb-3">
												<li>
													...
													<label for="aa-41" class="checkbox-custom-label">مصطفی اسلامی<i class="count">12</i></label>
												</li>
												<li>
													<input id="aa-2" class="checkbox-custom" name="aa-2" type="checkbox">
													<label for="aa-2" class="checkbox-custom-label">نرگس حسینی<i class="count">10</i></label>
												</li>
												<li>
													<input id="aa-3" class="checkbox-custom" name="aa-3" type="checkbox">
													<label for="aa-3" class="checkbox-custom-label">سروش نجفی نژاد<i class="count">56</i></label>
												</li>
												<li>
													<input id="aa-71" class="checkbox-custom" name="aa-71" type="checkbox">
													<label for="aa-71" class="checkbox-custom-label">متین کفاشیان<i class="count">42</i></label>
												</li>
												<li>
													<input id="aa-81" class="checkbox-custom" name="aa-81" type="checkbox">
													<label for="aa-81" class="checkbox-custom-label">نادیا ناصری<i class="count">12</i></label>
												</li>
												<li>
													<input id="aa-91" class="checkbox-custom" name="aa-91" type="checkbox">
													<label for="aa-91" class="checkbox-custom-label">مرضیه قاسمی نیا<i class="count">36</i></label>
												</li>
											</ul>
										</div>
										...
										<div class="form-group">
											...
											<ul class="no-ul-list mb-3">
												<li>
													...
													<label for="p1" class="checkbox-custom-label">همه<i class="count">89</i></label>
												</li>
												<li>
												...
												<li>
													...
													<label for="p3" class="checkbox-custom-label">پولی<i class="count">42</i></label>
												</li>
											</ul>
										</div>
						...
						<div class="col-xl-8 col-lg-8 col-md-12">
										...
										<div class="row m-0 align-items-center justify-content-between">
											...
											<div class="col-lg-4 col-md-5 col-sm-12  col-sm-6">
												<div class="shorting_pagination_laft">
													<h6 class="m-0">نمایش 1-25 از 72</h6>
												</div>
											</div>
							...
							<div class="row justify-content-center">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-8.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس برتر شیمی</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">نرگس حسینی</a></h4></div>
											<div class="trt_rate_inf">
												...
												<span class="alt_rates">(244 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 2.5 نفر شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-1.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس برتر ریاضیات</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">سروش نجفی زاده</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(119 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 3.2 نفر شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-2.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس برتر تاریخ</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">نادیا ناصری</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(96 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 2.2 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-3.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس زبان انگلیسی</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">متین کفاشیان</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(149 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 3.1 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-4.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس جاوا اسکریپت</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">مرضیه قاسمی نیا</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(204 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 2.3 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-5.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مولف و مدرس شیمی</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">مهرداد علیزاده</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(74 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 1.5 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-7.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>دکترای مدرس حسابداری</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">رضا مرادی</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star-half filled"></i>
												<span class="alt_rates">(73 امتیاز)</span>
											</div>
										</div>
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 2.1 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										<div class="crs_trt_thumb circle">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-6.png" class="img-fluid circle" alt=""></a>
										</div>
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس برتر فیزیک</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">نیلوفر کاشفی</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
										...
										<div class="crs_trt_footer">
											<div class="crs_trt_ent"><i class="fa fa-user"></i> 1.2 شرکت کننده</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="crs_trt_grid">
										...
										<div class="crs_trt_caption">
											<div class="instructor_tag dark"><span>مدرس برتر پایتون</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">محمد کریمی</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
				...
				<div class="modal-dialog modal-xl login-pop-form" role="document">
					<div class="modal-content overli" id="loginmodal">
						...
						<div class="crs_log__footer d-flex justify-content-between mt-0">
							<div class="fhg_45"><p class="musrt">حساب کاربری ندارید؟ <a href="signup.blade.php" class="theme-cl">ثبت نام</a></p></div>
							<div class="fhg_45"><p class="musrt"><a href="forgot.blade.php" class="text-danger">رمز عبور را فراموش کرده اید؟</a></p></div>
						</div>
					</div>
				</div>
			</div>
