					...
					<div class="row align-items-center mb-5">
						<div class="col-lg-3 col-md-12 col-sm-12">
							<div class="authi_125">
								...
								<a href="#" class="klio_45"><div class="lklo_45"><i class="fas fa-play"></i></div><p>پیش نمایش</p></a>
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-12 col-sm-12">
							<div class="dlkio_452">
								<div class="ed_detail_wrap">
									<div class="crs_cates cl_1"><span>گرافیک</span></div><div class="crs_cates cl_3"><span>طراح</span></div>
									<div class="ed_header_caption">
										<h2 class="ed_title font-2">نادیا ناصری</h2>
										<ul>
									...
									<div class="ed_header_short">
										<p> ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد ...<a href="#" class="theme-cl"> بیشتر بخوانید</a></p>
									</div>
									...
									<div class="ed_rate_info">
										...
										<div class="review_counter">
											<strong class="high">4.7</strong> 3572 نظر ثبت شده
										</div>
									</div>
								...
								<div class="dlkio_last">
									<div class="ed_view_link">
										...
										<a href="#" class="btn theme-border enroll-btn">اشتراک گذاری<i class="fas fa-share"></i></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
							...
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_8"><span>گرافیک</span></div>
										</div>
										<div class="crs_fl_last">
											<div class="crs_inrolled"><strong>8,350</strong>شرکت کننده</div>
										</div>
									</div>
									<div class="crs_title"><h4><a href="course-detail.html" class="crs_title_link">آموزش تدوین و میکس ویدئو با Premier</a></h4></div>
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>5ساعت 2دقیقه</span></li>
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-6.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">نادیا ناصری</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
							...
							<div class="crs_grid">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/team-5.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">شهاب سنایی</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
							...
							<div class="crs_grid">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-4.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">مژگان علیزاده</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>5 ساعت</span></li>
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-3.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">علی حسینی</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_6"><span>پروژه محور</span></div>
										</div>
										<div class="crs_fl_last">
									...
									<div class="crs_info_detail">
										<ul>
											<li><i class="fa fa-clock text-danger"></i><span>8ساعت 2دقیقه</span></li>
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-2.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">نگین قاسمی</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_cates cl_7"><span>ریاضیات</span></div>
										</div>
										<div class="crs_fl_last">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-1.jpg" class="img-fluid circle" alt="" /></a></div><div class="crs_tutor_name"><a href="instructor-detail.blade.php">مصطفی اسلامی</a></div>
											</div>
										</div>
										<div class="crs_fl_last">
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8 mt-2">
							<div class="text-center"><a href="grid-layout-with-sidebar.html" class="btn btn-md theme-bg-light theme-cl">سایر دوره های آموزش</a></div>
						</div>
					</div>
