						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="simple-search-wrap text-right">
								<div class="hero_search-2">
									...
									<p class="font-lg mb-4">مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد.
				...
				<div class="container">
							...
							<div class="crs_grid">
								...
								<div class="crs_grid_foot">
									<div class="crs_flex">
										<div class="crs_fl_first">
											<div class="crs_tutor">
												<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/team-5.jpg" class="img-fluid circle" alt="" /></a></div>
											</div>
										</div>
										<div class="crs_fl_last">
							...
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									<div class="crs_flex">
										...
										<div class="crs_fl_last">
											<div class="crs_price"><h2><span class="theme-cl">139</span><span class="currency">تومان</span></h2></div>
										</div>
									</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									...
									<div class="crs_title"><h4><a href="course-detail.html" class="crs_title_link">آموزش پریمیر - تدوین و میکس ویدئو با Premier</a></h4></div>
									<div class="crs_info_detail">
										<ul>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
							<div class="crs_grid">
								...
								<div class="crs_grid_caption">
									...
									<div class="crs_title"><h4><a href="course-detail.html" class="crs_title_link">آموزش برنامه نویسی پایتون Python - مقدماتی</a></h4></div>
									<div class="crs_info_detail">
										<ul>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8 mt-2">
							<div class="text-center"><a href="grid-layout-with-sidebar.html" class="btn btn-md theme-bg-light theme-cl">همه آموزش ها</a></div>
						</div>
					</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="tutor-slide">
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-1.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
											<div class="instructor_tag"><span>مدرس برتر ریاضیات و فیزیک</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">مصطفی اسلامی</a></h4></div>
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-2.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-3.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
											<div class="instructor_tag"><span>مدرس برتر شیمی</span></div>
											<div class="instructor_title"><h4><a href="instructor-detail.blade.php">سروش نجفی نژاد</a></h4></div>
											<div class="trt_rate_inf">
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
												<i class="fa fa-star filled"></i>
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-4.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-5.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
								...
								<div class="lios_item">
									<div class="crs_trt_grid shadow_none brd">
										<div class="crs_trt_thumb">
											<a href="instructor-detail.blade.php" class="crs_trt_thum_link"><img src="assets/img/t-6.png" class="img-fluid" alt="" /></a>
										</div>
										<div class="crs_trt_caption large">
			...
			<section class="min">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-8">
							<div class="sec-heading center">
								<h3 class="font-2">پکیج تدریس <span class="theme-cl">غیرحضوری</span></h2>
								<p>با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</p>
							</div>
						</div>
					</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-4 col-md-4">
							<div class="pricing_wrap">
								<div class="prt_head">
									<div class="recommended">پیشنهاد هفته</div>
									<h4>نقره ای</h4>
								</div>
								<div class="prt_price">
