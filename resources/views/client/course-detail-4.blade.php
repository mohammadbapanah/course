				...
				<div class="container">
					<div class="row align-items-center justify-content-between mb-2">
							...
							<div class="dlkio_452">
								<div class="ed_detail_wrap">
									...
									<div class="ed_header_caption">
										<h2 class="ed_title">آموزش تدوین و میکس ویدئو با Premier</h2>
									</div>
									<div class="d-flex align-items-center mt-4">
										<div class="rounded-circle d-flex align-items-center justify-content-center">
										  <img src="assets/img/team-3.jpg" class="img-fluid circle" width="70" alt="" />
										</div>
										<div class="mr-2 mr-md-3">
										  <span>مدرس</span>
										   <h6 class="m-0">مصطفی اسلامی</h6>
										</div>
									</div>
						...
						<div class="col-xl-4 col-lg-5 col-md-5 col-sm-12">
							<ul class="row p-0">
								<li class="col-lg-6 col-md-6 col-sm-6 pt-2 pb-2"><i class="fas fa-star ml-1 text-warning"></i><span>4.9 امتیاز (5,254)</span></li>
								<li class="col-lg-6 col-md-6 col-sm-6 pt-2 pb-2"><i class="fas fa-clock ml-1 text-success"></i><span>4 ساعت 52 دقیقه</span></li>
								<li class="col-lg-6 col-md-6 col-sm-6 pt-2 pb-2"><i class="fas fa-user ml-1 text-info"></i><span>2,54,740 شرکت کننده</span></li>
								<li class="col-lg-6 col-md-6 col-sm-6 pt-2 pb-2"><i class="fas fa-video ml-1 text-danger"></i><span>47 ویدئو آموزشی</span></li>
							</ul>
						</div>
						...
						<div class="col-lg-4 col-md-12 order-lg-last">
							...
							<div class="ed_view_box style_2 border ovrlio stick_top min">
								...
								<div class="ed_view_link">
									<a href="#" class="btn theme-light enroll-btn">عضویت<i class="ti-angle-left"></i></a>
								...
								<div class="ed_view_features">
									<div class="eld mb-3">
										...
										<p>این سایت دارای مجوز رسمی از جمهوری اسلامی ایران بوده و به استناد نماد های زیر، خرید از این وب سایت کاملاً ایمن و تایید شده می باشد!</p>
									</div>
									<div class="eld mb-3">
										<ul class="edu_list right">
											<li><i class="ti-user"></i>تعداد شرکت کننده:<strong>1740 نفر</strong></li>
											<li><i class="ti-files"></i>موضوع:<strong>Premiere</strong></li>
											<li><i class="ti-game"></i>تعداد پروژه:<strong>4</strong></li>
											<li><i class="ti-time"></i>تعداد دوره:<strong>32 دوره</strong></li>
											<li><i class="ti-tag"></i>سطح:<strong>مقدماتی</strong></li>
										</ul>
									</div>
								</div>
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-6.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-5.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
													<div class="foot_list_info">
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-4.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
													<div class="foot_list_info">
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-3.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
													<div class="foot_list_info">
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-2.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
													<div class="foot_list_info">
									...
									<div class="crs_grid shadow_none brd">
										...
										<div class="crs_grid_foot">
											<div class="crs_flex">
												<div class="crs_fl_first">
													<div class="crs_tutor">
														<div class="crs_tutor_thumb"><a href="instructor-detail.blade.php"><img src="assets/img/user-1.jpg" class="img-fluid circle" alt="" /></a></div>
													</div>
												</div>
												<div class="crs_fl_last">
													<div class="foot_list_info">
