							...
							<div class="row justify-content-between">
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<div class="dashboard_wrap d-flex align-items-center justify-content-between">
										...
										<div class="elkios">
											<a href="add-admin.blade.php" class="add_new_btn"><i class="fas fa-plus-circle ml-1"></i>افزودن مدیر</a>
										</div>
									</div>
								</div>
							</div>
													...
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																...
																<td><span class="trip text-white theme-bg">مدیر</span></td>
															</tr>
															<tr>
																<th scope="row">2</th>
																...
																<td>
																	<div class="dropdown show">
																		...
																		<div class="drp-select dropdown-menu">
																			<a class="dropdown-item" href="JavaScript:Void(0);">مجوز</a>
