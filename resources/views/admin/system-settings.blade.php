									...
									<ul id="side-menu">
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="manage-course.blade.php">مدیریت</a></li>
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="manage-admins.blade.php">مدیریت</a></li>
										...
										<li class="dropdown">
											...
											<ul class="nav nav-second-level">
												<li><a href="manage-instructor.blade.php">مدیریت</a></li>
												<li><a href="add-instructor.blade.php">ثبت مدرس جدید</a></li>
												<li><a href="instructor-payout.blade.php">پرداخت های مدرس</a></li>
											</ul>
										</li>
										<li class="dropdown">
											<a href="javascript:void(0);"><i class="fas fa-user"></i>هنرجویان<span class="ti-angle-left"></span></a>
											<ul class="nav nav-second-level">
												<li><a href="manage-students.blade.php">مدیریت</a></li>
												<li><a href="add-students.blade.php">ثبت هنرجو جدید</a></li>
											</ul>
										</li>
										<li><a href="addon-manager.blade.php"><i class="fas fa-layer-group"></i>افزونه ها</a></li>
										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">تنظیمات سئو</li>
												</ol>
											</nav>
										</div>
									</div>
											...
											<div class="col-xl-12 col-lg-12 col-md-12">
												<form>
													...
													<div class="form-group smalls">
														...
														<input type="text" class="form-control" placeholder="قالب HTML دوره آنلاین و آموزش" />
													</div>
													<div class="form-group smalls">
														<label>کلمات کلیدی</label>
														<input type="text" class="form-control" placeholder="آموزش، دوره آنلاین، قالب آموزشی، بهترین قالب" />
													</div>
													<div class="form-group smalls">
														<label>توضیحات وب سایت</label>
														<textarea class="form-control summernote"></textarea>
													</div>
													<div class="form-group smalls">
														<label>نام نویسنده</label>
														<input type="text" class="form-control" placeholder="توسعه پردازان" />
													</div>
													<div class="form-group smalls">
														<label>شعار*</label>
														<input type="text" class="form-control" placeholder="بهترین بستر آموزشی" />
													</div>
													<div class="form-group smalls">
														<label>ایمیل*</label>
													...
													<div class="form-group smalls">
														<label>آدرس</label>
														<textarea class="form-control" placeholder="ایران، تهران، میدان آزادی"></textarea>
													</div>
													<div class="form-group smalls">
														<label>لینک YouTube*</label>
														<input type="text" class="form-control" placeholder="https://www.youtube.com/watch?v=ExXhmuH-cw8" />
													</div>
													<div class="form-group smalls">
														<label>لینک Vimeo*</label>
													...
													<div class="form-group smalls">
														<label>ارسال ایمیل تایید دانشجو</label>
													...
													<div class="form-group smalls">
														...
														<div class="simple-input">
															<select id="lgu" class="form-control">
																...
																<option value="3">اسپانیایی</option>
																<option value="4">فرانسوی</option>
																<option value="5">ژاپنی</option>
															</select>
														</div>
													</div>
													<div class="form-group smalls">
													...
													<div class="form-group smalls">
														<label>لینک فوتر</label>
														<input type="text" class="form-control" />
													</div>
													<div class="form-group smalls">
														<button class="btn theme-bg text-white" type="button">ذخیره</button>
													</div>
												</form>
											</div>
										</div>
