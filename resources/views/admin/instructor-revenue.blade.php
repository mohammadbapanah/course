										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">درآمد مربی</li>
												</ol>
											</nav>
										</div>
									</div>
													...
													<table class="table dash_list">
														<thead>
															<tr>
																...
																<th scope="col">درآمد مربی</th>
																<th scope="col">تاریخ ثبت نام</th>
															</tr>
														</thead>
														<tbody>
															<tr>
																<td><h6>الگوی طراحی UI/UX برای برنامه های نرم افزاری موفق</h6></td>
																<td><span class="smalls lg">سارا حسینی</span></td>
																<td><span class="smalls lg">570 تومان</span></td>
																<td><span class="trip theme-cl theme-bg-light">320 تومان</span></td>
																<td><span class="smalls lg">1401-03-14</span></td>
															</tr>
															<tr>
																<td><h6>آموزش ساخت فروشگاه دیجی استایل با لاراول</h6></td>
																<td><span class="smalls lg">محسن علیزاده</span></td>
																<td><span class="smalls lg">1050 تومان</span></td>
																<td><span class="trip theme-cl theme-bg-light">740 تومان</span></td>
																<td><span class="smalls lg">1401-01-12</span></td>
															</tr>
															<tr>
																<td><h6>معرفی و مقایسه زبان های برنامه نویسی</h6></td>
																<td><span class="smalls lg">علی عظیمی</span></td>
																<td><span class="smalls lg">760 تومان</span></td>
																<td><span class="trip theme-cl theme-bg-light">520 تومان</span></td>
																<td><span class="smalls lg">1401-02-08</span></td>
															</tr>
															<tr>
																<td><h6>دوره کامل حسابداری و مالی بانکی 2021</h6></td>
																<td><span class="smalls lg">مژگان اسلامی</span></td>
																<td><span class="smalls lg">1540 تومان</span></td>
																<td><span class="trip theme-cl theme-bg-light">1020 تومان</span></td>
																<td><span class="smalls lg">1400-12-28</span></td>
															</tr>
														</tbody>
													</table>
												</div>
