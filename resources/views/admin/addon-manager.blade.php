										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">افزونه های من</li>
												</ol>
											</nav>
										</div>
									</div>
											...
											<div class="col-xl-12 col-lg-12 col-md-12 mb-2">
												<div class="table-responsive">
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																<td><div class="smalls lg">ارسال مقاله</div></td>
																...
																<td>
																	<div class="dropdown show">
																		...
																		<div class="drp-select dropdown-menu">
																			<a class="dropdown-item" href="JavaScript:Void(0);">غیرفعال</a>
															...
															<tr>
																<td><div class="smalls lg">کوتاه کننده لینک</div></td>
																<td><span class="smalls lg">4.10.2</span></td>
																<td><span class="trip text-danger bg-light-danger">غیرفعال</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
																		...
																		<div class="drp-select dropdown-menu">
																			<a class="dropdown-item" href="JavaScript:Void(0);">فعال</a>
																			<a class="dropdown-item" href="JavaScript:Void(0);">حذف</a>
																		</div>
																	</div>
																</td>
															...
															<tr>
																<td><div class="smalls lg">افزونه سازنده صفحه</div></td>
