										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">دسته بندی دوره</li>
												</ol>
											</nav>
										</div>
										<div class="elkios">
											<a href="#" class="add_new_btn" data-toggle="modal" data-target="#catModal"><i class="fas fa-plus-circle ml-1"></i>افزودن دسته بندی</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
									...
									<div class="dash_crs_cat">
										...
										<div class="dash_crs_cat_caption">
											<div class="dash_crs_cat_head">
												<h4>برنامه نویسی</h4>
												<span>5 دسته بندی فرعی</span>
											</div>
											<div class="dash_crs_cat_body">
												<ul>
													<li><span>طراحی واکنشگرا</span></li>
											...
											<div class="dash_crs_cat_bottom">
												<a href="#" class="btn full-width theme-bg-light theme-cl">ویرایش</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="dash_crs_cat">
										...
										<div class="dash_crs_cat_caption">
											...
											<div class="dash_crs_cat_body">
												<ul>
													<li><span>مالی</span></li>
													<li><span>استارت آپ</span></li>
													<li><span>برنامه ریزی کسب و کار</span></li>
													<li><span>حسابداری</span></li>
													<li><span>نرم افزار هلو</span></li>
												</ul>
											</div>
											<div class="dash_crs_cat_bottom">
												<a href="#" class="btn full-width theme-bg-light theme-cl">ویرایش</a>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="dash_crs_cat">
										<a href="#" class="remove_tools"><i class="fas fa-trash-alt"></i></a>
										<div class="dash_crs_cat_thumb">
											<img src="assets/img/cr-4.jpg" alt="" class="img-fluid" />
										</div>
										<div class="dash_crs_cat_caption">
											<div class="dash_crs_cat_head">
												<h4>طراحی داخلی</h4>
											...
											<div class="dash_crs_cat_body">
												<ul>
													<li><span>ترکیب رنگ</span></li>
													<li><span>طراحی نور</span></li>
													<li><span>بازسازی خانه</span></li>
													<li><span>نورپردازی سه بعدی</span></li>
													<li><span>تزیین اتاق خواب</span></li>
												</ul>
											</div>
											<div class="dash_crs_cat_bottom">
												<a href="#" class="btn full-width theme-bg-light theme-cl">ویرایش</a>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
									<div class="dash_crs_cat">
										<a href="#" class="remove_tools"><i class="fas fa-trash-alt"></i></a>
										<div class="dash_crs_cat_thumb">
											<img src="assets/img/cr-5.jpg" alt="" class="img-fluid" />
										</div>
										<div class="dash_crs_cat_caption">
											<div class="dash_crs_cat_head">
												<h4>انیمیشن دو بعدی / سه بعدی</h4>
												<span>5 دسته بندی فرعی</span>
											</div>
											<div class="dash_crs_cat_body">
												<ul>
													<li><span>جلوه حرکت</span></li>
													<li><span>بلندر</span></li>
													<li><span>ابزارهای مایا</span></li>
													<li><span>افتر افکت</span></li>
													<li><span>ابزارهای حرفه ای</span></li>
												</ul>
																								</div>
											<div class="dash_crs_cat_bottom">
												<a href="#" class="btn full-width theme-bg-light theme-cl">ویرایش</a>
