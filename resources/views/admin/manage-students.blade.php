							...
							<div class="row justify-content-between">
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<div class="dashboard_wrap d-flex align-items-center justify-content-between">
										...
										<div class="elkios">
											<a href="add-students.blade.php" class="add_new_btn"><i class="fas fa-plus-circle ml-1"></i>افزودن هنرجو</a>
										</div>
									</div>
								</div>
							</div>
													...
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																...
																<td><div class="smalls lg">حسن علیزاده</div></td>
																<td><span class="smalls lg">Beltran@teleworm.us</span></td>
																<td><span class="smalls lg">طراحی سایت</span></td>
																<td>
															...
															<tr>
																...
																<td><div class="smalls lg">علی مرادی</div></td>
																<td><span class="smalls lg">Paxson@armyspy.com</span></td>
																<td><span class="smalls lg">JavaScript</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">لیندا قاسمی نیا</span></td>
																<td><span class="smalls lg">FrankTFleck@rhyta.com</span></td>
																<td><span class="smalls lg">انیمیشن سه بعدی</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">زهرا امیری</span></td>
																<td><span class="smalls lg">CarloJone@armyspy.com</span></td>
																<td><span class="smalls lg">Laravel</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">محمد کسایی</span></td>
																<td><span class="smalls lg">LeonAarker@rhyta.com</span></td>
																<td><span class="smalls lg">طراحی گرافیک</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
