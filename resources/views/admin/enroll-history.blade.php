...
<head>
        ...
        <!-- Custom CSS -->
		<link href="assets/css/plugins/daterangepicker.css" rel="stylesheet">
		<link href="assets/css/plugins/datepicker-theme.css" rel="stylesheet">
								...
								<div class="col-xl-12 col-lg-12 col-md-12">
									<div class="dashboard_wrap">
										...
										<div class="form-group smalls">
											<label>تاریخچه ثبت نام</label>
											<div class="row m-0">
												<input type="text" class="col-9 col-sm-9 form-control input-daterange-datepicker" name="dates" value="08/05/2021 - 10/10/2021">
