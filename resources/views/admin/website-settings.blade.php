											...
											<div class="col-xl-12 col-lg-12 col-md-12">
												<form>
													<div class="form-group smalls">
														<label>نام بنر*</label>
														<input type="text" class="form-control" placeholder="بهترین مکان آموزشی" />
													</div>
													<div class="form-group smalls">
														<label>نام دوم بنر*</label>
														<input type="text" class="form-control" placeholder="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است." />
													</div>
													<div class="form-group smalls">
														<label>وضعیت کوکی*</label>
														<div class="d-flex">
															<div class="drios">
																<input id="450" class="checkbox-custom" name="cookie" type="radio" checked>
																<label for="450" class="checkbox-custom-label">فعال</label>
															</div>
															<div class="drios ml-3">
																<input id="451" class="checkbox-custom" name="cookie" type="radio">
																<label for="451" class="checkbox-custom-label">غیرفعال</label>
															</div>
														</div>
													</div>
													<div class="form-group smalls">
														<label>شرایط کوکی</label>
												...
												<form>
													<div class="form-group smalls">
														...
														<div class="custom-file">
														  ...
														  <label class="custom-file-label" for="bimage">آپلود فایل</label>
														</div>
													</div>
													<div class="form-group smalls">
														<label>لوگو*</label>
														<div class="custom-file">
														  ...
														  <label class="custom-file-label" for="logo">آپلود فایل</label>
														</div>
													</div>
													<div class="form-group smalls">
														<label>لوگو نسخه روشن*</label>
														<div class="custom-file">
														  <input type="file" class="custom-file-input" id="llogo">
														  <label class="custom-file-label" for="llogo">آپلود فایل</label>
														</div>
													</div>
													<div class="form-group smalls">
														<label>فاوآیکن*</label>
														<div class="custom-file">
														  ...
														  <label class="custom-file-label" for="favi">آپلود فایل</label>
														</div>
													</div>
													<div class="form-group smalls">
														<button class="btn theme-bg text-white" type="button">ذخیره</button>
